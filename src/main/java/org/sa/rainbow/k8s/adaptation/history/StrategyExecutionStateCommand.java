...
public class StrategyExecutionStateCommand
    extends AbstractRainbowModelOperation<
        ExecutionHistoryData.ExecutionPoint, Map<String, ExecutionHistoryData>> {

  private ExecutionHistoryData m_data;
  private ExecutionHistoryData m_oldData;

  public StrategyExecutionStateCommand(
      String commandName,
  ...
  @Override
  protected List<? extends IRainbowMessage> getGeneratedEvents(
      IRainbowMessageFactory messageFactory) {
  ...
  protected void subExecute() throws RainbowException {
    ...
    datum.addExecutionTransition(
        getParameters()[0],
        ExecutionHistoryData.ExecutionStateT.valueOf(getParameters()[1]),
        getParameters()[2]);
    m_data = datum;
  }
